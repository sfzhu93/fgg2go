...
import (
	...
	"github.com/sfzhu93/fgg2go/internal/fgr"
...
var (
	...
	dictpass                   bool
	dictpassOptimizedAssertion bool // reduce the type simulations for types with zero type parameters
...
func init() {
	...
	flag.BoolVar(&dictpassOptimizedAssertion, "dictpass-opt-assertion", false,
		"when enabled, dict translation avoids generate type simulation for types with zero type parameters")
...
func main() {
	...
	case interpFGG:
		...
		if dictpass {
			intrp_fgg.DictPass(false, dictpassOptimizedAssertion)
		} else if dictpassnoassertion {
			intrp_fgg.DictPass(true, dictpassOptimizedAssertion)
		} else if dynamic {
			intrp_fgg.Dyn()
		}
