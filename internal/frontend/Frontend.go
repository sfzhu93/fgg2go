...
import (
	...
	"github.com/sfzhu93/fgg2go/internal/fgg/dictpass"
	"github.com/sfzhu93/fgg2go/internal/fgg/dyn"
...
func (intrp *FGGInterp) DictPass(noassertion bool, optimizedAssertion bool) {
	p_fgg := intrp.GetSource().(fgg.FGGProgram)
	p_mono := dictpass.TranslateToDictPassFG(p_fgg, noassertion, optimizedAssertion)
